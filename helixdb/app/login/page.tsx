    ...
    />
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-black">
        ...
        <form className="md:w-96 w-80 flex flex-col items-center justify-center">
          ...
          <button
            type="button"
            className="w-full mt-8 bg-gray-500/10 flex items-center justify-center h-12 rounded-full border  hover:bg-gray-500/30 border-blue-600"
          >
            <img
          ...
          <button
            type="submit"
            className="mt-8 w-full h-11 rounded-full font-bold text-black bg-red-500 hover:opacity-70 transition-opacity"
            onClick={() => router.push("/")}
          >
            Login
          </button>
